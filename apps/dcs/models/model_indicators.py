...
from .model_sensor import DcsSensor

class DcsIndicators(models.Model):  # Показания датчиков
    """
    ...
    sensor = models.ForeignKey(DcsSensor,
    ...
    class Meta:   # отображение в админики
        ...
        indexes = [models.Index(fields=['date_time','sensor',]),]
